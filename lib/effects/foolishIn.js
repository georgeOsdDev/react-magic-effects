...
exports.default = function (progress) {
  ...
  if (progress < 20) {
    ...
    transformOrigin = _utils2.default.calc(50, 0, progress) + '%, ' + _utils2.default.calc(50, 100, progress) + '%';
    transform = 'scale(' + _utils2.default.calc(0, 0.5, progress) + ', ' + _utils2.default.calc(0, 0.5, progress) + ') rotate(' + _utils2.default.calc(360, 0, progress) + 'deg)';
  } else if (progress < 40) {
    ...
    opacity = 1;
    transformOrigin = _utils2.default.calc(0, 50, progress) + '%, ' + _utils2.default.calc(0, 50, progress) + '%';
    transform = 'scale(' + _utils2.default.calc(0.5, 1, progress) + ', ' + _utils2.default.calc(0.5, 1, progress) + ') rotate(0deg)';
  }
