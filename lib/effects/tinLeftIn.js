...
exports.default = function (progress) {
  ...
  if (progress < 50) {
    ...
    transform = 'scale(' + _utils2.default.calc(1, 1.1, progress) + ', ' + _utils2.default.calc(1, 1.1, progress) + ') translateX(' + _utils2.default.calc(-900, 0, progress) + '%)';
  } else if (progress < 60) {
    progress = (progress - 50) * 10;
    opacity = 1;
    transform = 'scale(' + _utils2.default.calc(1.1, 1, progress) + ', ' + _utils2.default.calc(1.1, 1, progress) + ') translateX(0)';
  } else if (progress < 70) {
